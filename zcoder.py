...
while(True):#repeat
    if (update):
        ...
        draw_rotated_text(disp.buffer, "X2: " + str(X2*50), (10, 150), text_rotation, font, fill=(255, 255, 255))
        draw_rotated_text(disp.buffer, "Y2: " + str(Y2*50), (10, 110), text_rotation, font, fill=(255, 255, 255))
        draw.line(120, 160, (X2*20)+120, (Y2*20)+160, fill=(255, 255, 255))

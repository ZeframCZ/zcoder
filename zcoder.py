...
while(True):#repeat
    if (update):
        ...
        draw_rotated_text(disp.buffer, "X2: " + str(X2), (200, 150), text_rotation, font, fill=(255, 255, 255))
        draw_rotated_text(disp.buffer, "Y2: " + str(Y2), (200, 110), text_rotation, font, fill=(255, 255, 255))

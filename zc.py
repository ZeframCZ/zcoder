...
while(True):#repeat
    ...
    draw_rotated_text(disp.buffer, str(date.day)+"."+str(date.month)+"."+str(date.year)+"  "+str(date.hour)+":"+str(date.minute)+":"+str(date.min), (0 + w1/2, 8), text_rotation, font_small, fill=(255, 255, 255))
